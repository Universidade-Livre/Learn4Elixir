...
5. Após terminar as soluções do capítulo (ou até mesmo se tiver dificuldade e precisar de ajuda) você pode abir um PR **para o seu fork** com a solução e mencionar @[douglastofoli](https://github.com/douglastofoli), @... ou @[OtavioSC](https://github.com/otaviosc) que vamos ajudá-lo com a revisão de suas soluções.
